...
ProjectTree is the implementation of the generic Tree class for csharp-timesheet. ZoomableCanvas is a canvas you can move around and zoom in/out. ViewManageProject is where the implementation of the view using the graph start.
